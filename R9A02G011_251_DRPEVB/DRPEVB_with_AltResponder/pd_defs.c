...
const ULONG  PD_SNK_PDO2   = 0x000190C8UL; //  5V,2A
const ULONG  PD_SNK_PDO3   = 0x0002D12CUL; //  9V,3A
// const ULONG  PD_SNK_PDO4   = 0x0004B12CUL; // 15V,3A
const ULONG  PD_SNK_PDO4   = 0x00000000UL; // 15V disabled for now
