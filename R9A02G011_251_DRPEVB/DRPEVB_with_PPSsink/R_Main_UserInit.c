...
void R_MAIN_UserInit(void)
{
	...
	pdc_set_snk_conf(60000U, 6, 1);
	pdc_set_sys_conf(PDC_SYS_DR_SWAP_PASSIVE, PDC_SYS_PR_SWAP_PASSIVE, (PDC_SYS_UNCNST_PWR | PDC_SYS_EXT_PWR_DC), 0x00U);
