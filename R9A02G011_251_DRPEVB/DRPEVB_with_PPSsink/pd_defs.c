...
const ULONG  PD_SRC_PDO3   = 0x0004B12CU;
const ULONG  PD_SRC_PDO4   = 0x0006412CU;
const ULONG  PD_SRC_PDO5   = 0x00000000U;
const ULONG  PD_SRC_PDO6   = 0x00000000U;
const ULONG  PD_SRC_PDO7   = 0x00000000U;

const ULONG  PD_SNK_PDO2   = 0x0002D12CU; //9V3A
const ULONG  PD_SNK_PDO3   = 0x0003C12CU; //12V3A
const ULONG  PD_SNK_PDO4   = 0x0004B12CU; //15V3A
const ULONG  PD_SNK_PDO5   = 0x0006412CU; //20V3A
const ULONG  PD_SNK_PDO6   = 0xC076213CU; //PPS 3.3V/5.9V/3A
...
const UCHAR  PD_SKEDB_SNK_MODES   = 0x07U;
