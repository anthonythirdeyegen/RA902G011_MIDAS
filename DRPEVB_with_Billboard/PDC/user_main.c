...
void user_init(void)
{
	...
	POM5_bit.no0 = 0U; P5_bit.no0 = 1U; PM5_bit.no0 = 1U; // DM        :P50 (Normal drive, input when idle)
	POM5_bit.no1 = 0U; P5_bit.no1 = 1U; PM5_bit.no1 = 1U; // DP        :P51 (Normal drive, input when idle)
	                   P7_bit.no1 = 0U; PM7_bit.no1 = 0U; // DISCHG    :P71
	                   P7_bit.no3 = 0U; PM7_bit.no3 = 0U; // DR_GATE   :P73
	POM8_bit.no0 = 0U; P8_bit.no0 = 0U; PM8_bit.no0 = 0U; // PUE       :P80 (Normal drive, low when idle)
