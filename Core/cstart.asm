...
;	flash Table
;-----------------------------------------------------------------------------
FLASH_TABLE	.EQU	FW_START_ADDRESS
;INTERRUPT_OFFSET	.EQU	0x100
;	.EXTERN	_start
;	.EXTERN	_f1
;	.EXTERN	_f2
; For interrupt funxtion
.jtext	.CSEG AT FLASH_TABLE
	BR		!!_start
	.DB2	0x0000
	.DB2	0x0000
	.DB2	MAGIC_CODE
	.DB2	FLASH_FW_VERSION
	.DB2	FW_TYPE
; For function
...
;	flash Table
;-----------------------------------------------------------------------------
FLASH_END_TABLE	.EQU	FW_END_ADDRESS
.jtext	.CSEG AT FLASH_END_TABLE
	.DB2	MAGIC_CODE