...
void R_MAIN_UserInit(void)
{
	...
	pdc_set_src_conf(45000U, 5, 0, PDC_NOPD_CUR_3_0A);
	pdc_set_snk_conf(63000U, 3, 1);
	pdc_set_sys_conf(PDC_SYS_DR_SWAP_PASSIVE, PDC_SYS_PR_SWAP_ACTIVE_SRC, (PDC_SYS_UNCNST_PWR | PDC_SYS_EXT_PWR_DC | PDC_SYS_INTR_PWR_BAT), 0x00U);
