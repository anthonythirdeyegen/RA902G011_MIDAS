...
const UCHAR  PD_PDM_SPRT_GET_BAT_CAP    = 1U;
const UCHAR  PD_PDM_SPRT_GET_BAT_STATUS = 1U;
...
const UCHAR  PD_FW_VER     = 0x01U;        // Firmware version number
const UCHAR  PD_HW_VER     = 0x01U;        // Hardware version number
...
const USHORT PD_SRC_PDO1_MAX_CUR   = 0x012CU;
const USHORT PD_SNK_PDO1_OPE_CUR     = 0x012CU;

const ULONG  PD_SRC_PDO2   = 0x0002D12CU;
const ULONG  PD_SRC_PDO3   = 0x0003C12CU;
const ULONG  PD_SRC_PDO4   = 0x0004B12CU;
const ULONG  PD_SRC_PDO5   = 0x000640E1U;
const ULONG  PD_SRC_PDO6   = 0x00000000U;
const ULONG  PD_SRC_PDO7   = 0x00000000U;

const ULONG  PD_SNK_PDO2   = 0x9A417D2CU;
const ULONG  PD_SNK_PDO3   = 0xC076213CU;
const ULONG  PD_SNK_PDO4   = 0x00000000U;
const ULONG  PD_SNK_PDO5   = 0x00000000U;
const ULONG  PD_SNK_PDO6   = 0x00000000U;
const ULONG  PD_SNK_PDO7   = 0x00000000U;
...
const UCHAR  PD_SCEDB_BATTERIES   = 0x01U;
const UCHAR  PD_SCEDB_SRC_PDP     = 45U;
...
const UCHAR  PD_SKEDB_BAT_INFO    = 0x01U;
const UCHAR  PD_SKEDB_SNK_MODES   = 0x0BU;
