...
#define BBCHG_SET_CTRL3_BGATE		((UCHAR)0x16)

//Addtional register for ISL9238C
#define BBCHG_CTR6_DIS_UV			((UCHAR)0x17)
#define BBCHG_CTR6_EN_UV			((UCHAR)0x18)
#define BBCHG_CTR6_EN_SLEW			((UCHAR)0x19)
#define BBCHG_CTR4_EN_ADPDISCHG		((UCHAR)0x1A)
