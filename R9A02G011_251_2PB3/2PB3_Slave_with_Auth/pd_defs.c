...
const USHORT PD_SNK_PDO1_OPE_CUR   = 0x012CU; // 3A

const ULONG  PD_SRC_PDO2   = 0x0002D12CU; //  9V,3A
const ULONG  PD_SRC_PDO3   = 0x0003C12CU; // 12V,3A
const ULONG  PD_SRC_PDO4   = 0x0004B12CU; // 15V,3A
const ULONG  PD_SRC_PDO5   = 0x00000000U;
const ULONG  PD_SRC_PDO6   = 0x00000000U;
const ULONG  PD_SRC_PDO7   = 0x00000000U;

const ULONG  PD_SNK_PDO2   = 0x9A417D2CUL; //  21-4.75V,3A
const ULONG  PD_SNK_PDO3   = 0x00000000UL;
const ULONG  PD_SNK_PDO4   = 0x00000000UL;
const ULONG  PD_SNK_PDO5   = 0x00000000UL;
...
const UCHAR  PD_SKEDB_SNK_MODES   = 0x0AU;
